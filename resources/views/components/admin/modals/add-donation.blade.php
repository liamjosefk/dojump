<div class="modal fade mt-5" id="addDonationModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <div class="row width-100">
                            ...
                            <div class="col-6">
                                <button class="btn btn-primary btn-100" type="submit">Submit Donation</button>
                            </div>
                        </div>
                    </div>
                </div>
